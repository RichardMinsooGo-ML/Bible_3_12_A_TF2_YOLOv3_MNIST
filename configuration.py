...
YOLO_V3_WEIGHTS             = "/content/gdrive/MyDrive/Obj_detection_TF2_img/darknet_weights/yolov3.weights"
YOLO_V3_TINY_WEIGHTS        = "/content/gdrive/MyDrive/Obj_detection_TF2_img/darknet_weights/yolov3-tiny.weights"
YOLO_V4_WEIGHTS             = "/content/gdrive/MyDrive/Obj_detection_TF2_img/darknet_weights/yolov4.weights"
YOLO_V4_TINY_WEIGHTS        = "/content/gdrive/MyDrive/Obj_detection_TF2_img/darknet_weights/yolov4-tiny.weights"
...
if dataset_name == "mnist":
    ...
    if YOLO_TYPE == "yolov3":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v3_mnist"
        DATA_TYPE = "yolo_v3_mnist"
    elif YOLO_TYPE == "yolov4":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v4_mnist"
    ...
    if YOLO_TYPE == "yolov3":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v3_fashion_mnist"
        DATA_TYPE = "yolo_v3_fashion_mnist"
    elif YOLO_TYPE == "yolov4":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v4_fashion_mnist"
    ...
    if YOLO_TYPE == "yolov3":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v3_voc"
        DATA_TYPE = "yolo_v3_voc"
    elif YOLO_TYPE == "yolov4":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v4_voc"
    ...
    if YOLO_TYPE == "yolov3":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v3_coco"
        DATA_TYPE = "yolo_v3_coco"
    elif YOLO_TYPE == "yolov4":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v4_coco"
    ...
    if YOLO_TYPE == "yolov3":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v3_OID_v6"
        DATA_TYPE = "yolo_v3_OID_v6"
    elif YOLO_TYPE == "yolov4":
        TRAIN_CHECKPOINTS_FOLDER    = "/content/gdrive/MyDrive/Obj_detection_TF2_img/checkpoints/yolo_v4_OID_v6"
